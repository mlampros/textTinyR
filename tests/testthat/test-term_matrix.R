...
testthat::test_that("in case that the stemmer parameter is ngram_sequential and the stemmer_ngram parameter is less than 1 it returns an error", {
  ...
  testthat::expect_error( init$Term_Matrix(sort_terms = FALSE, to_lower = FALSE, to_upper = FALSE, utf_locale = "", remove_char = "", remove_punctuation_string = FALSE, remove_punctuation_vector = FALSE,
                                           ...
                                           min_num_char = 1, max_num_char = Inf, stemmer = "ngram_sequential", min_n_gram = 1, max_n_gram = 1, skip_n_gram = 1, skip_distance = 0, n_gram_delimiter = " ",
                                           
                                           stemmer_ngram = 0, stemmer_gamma = 0.0, stemmer_truncate = 3, stemmer_batches = 1, print_every_rows = 1000, normalize = NULL, tf_idf = FALSE,
                                           
                                           threads = 1, verbose = FALSE) )
})


testthat::test_that("in case that the stemmer parameter is ngram_sequential and the stemmer_gamma parameter is less than 0.0 it returns an error", {
  ...
  testthat::expect_error( init$Term_Matrix(sort_terms = FALSE, to_lower = FALSE, to_upper = FALSE, utf_locale = "", remove_char = "", remove_punctuation_string = FALSE, remove_punctuation_vector = FALSE,
                                           ...
                                           stemmer_ngram = 1, stemmer_gamma = -0.1, stemmer_truncate = 3, stemmer_batches = 1, print_every_rows = 1000, normalize = NULL, tf_idf = FALSE,
                                           
                                           threads = 1, verbose = FALSE) )
})


testthat::test_that("in case that the stemmer parameter is ngram_sequential and the stemmer_truncate parameter is less than 1 it returns an error", {
  ...
  testthat::expect_error( init$Term_Matrix(sort_terms = FALSE, to_lower = FALSE, to_upper = FALSE, utf_locale = "", remove_char = "", remove_punctuation_string = FALSE, remove_punctuation_vector = FALSE,
                                           ...
                                           stemmer_ngram = 1, stemmer_gamma = 0.0, stemmer_truncate = 0, stemmer_batches = 1, print_every_rows = 1000, normalize = NULL, tf_idf = FALSE,
                                           
                                           threads = 1, verbose = FALSE) )
})


testthat::test_that("in case that the stemmer parameter is ngram_sequential and the stemmer_batches parameter is less than 1 it returns an error", {
  ...
  testthat::expect_error( init$Term_Matrix(sort_terms = FALSE, to_lower = FALSE, to_upper = FALSE, utf_locale = "", remove_char = "", remove_punctuation_string = FALSE, remove_punctuation_vector = FALSE,
                                           ...
                                           stemmer_ngram = 1, stemmer_gamma = 0.0, stemmer_truncate = 1, stemmer_batches = 0, print_every_rows = 1000, normalize = NULL, tf_idf = FALSE,
                                           
                                           threads = 1, verbose = FALSE) )
})


testthat::test_that("in case that the stemmer parameter is ngram_overlap and the stemmer_ngram parameter is less than 1 it returns an error", {
  ...
  testthat::expect_error( init$Term_Matrix(sort_terms = FALSE, to_lower = FALSE, to_upper = FALSE, utf_locale = "", remove_char = "", remove_punctuation_string = FALSE, remove_punctuation_vector = FALSE,
                                           ...
                                           min_num_char = 1, max_num_char = Inf, stemmer = "ngram_overlap", min_n_gram = 1, max_n_gram = 1, skip_n_gram = 1, skip_distance = 0, n_gram_delimiter = " ",
                                           
                                           stemmer_ngram = 0, stemmer_gamma = 0.0, stemmer_truncate = 1, stemmer_batches = 1, print_every_rows = 1000, normalize = NULL, tf_idf = FALSE,
...
testthat::test_that("in case that the print_every_rows parameter is less than 1 it returns an error", {
  ...
  testthat::expect_error( init$Term_Matrix(sort_terms = FALSE, to_lower = FALSE, to_upper = FALSE, utf_locale = "", remove_char = "", remove_punctuation_string = FALSE, remove_punctuation_vector = FALSE,
                                           ...
                                           stemmer_ngram = 1, stemmer_gamma = 0.0, stemmer_truncate = 1, stemmer_batches = 1, print_every_rows = 0, normalize = NULL, tf_idf = FALSE,
...
testthat::test_that("in case that either the normalize parameter is not NULL or the tf_idf parameter is TRUE it returns an error", {
  ...
  res = init$Term_Matrix(sort_terms = FALSE, to_lower = TRUE, to_upper = FALSE, utf_locale = "", remove_char = "", remove_punctuation_string = FALSE, remove_punctuation_vector = FALSE,
                         ...
                         stemmer_ngram = 1, stemmer_gamma = 0.0, stemmer_truncate = 1, stemmer_batches = 1, print_every_rows = 100, normalize = NULL, tf_idf = T,
